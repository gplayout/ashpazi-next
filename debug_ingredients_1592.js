...
async function debugIngredients1592() {
    console.log("=== DEBUG INGREDIENTS 1592 (Soup Jo) ===");
    ...
    console.log("Sample:", JSON.stringify(tr.ingredients).slice(0, 100));
}

debugIngredients1592();
