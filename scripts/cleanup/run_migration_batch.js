...
async function runMigration() {
    console.log(`🚀 Starting Migration Phase 1: First ${BATCH_TARGET} Recipes...`);
    console.log(`ℹ️  Strict Mode: No Skips, Full Regeneration.`);
    ...
    console.log(`\n⚡ Step 3: Processing first ${BATCH_TARGET} recipes via API...`);
