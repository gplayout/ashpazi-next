                    ...
                    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
                        <div className="container flex h-14 max-w-screen-2xl items-center justify-between px-4">
                            <Link
                                href="/"
                                prefetch={false}
                                className="mr-6 flex items-center space-x-2 gap-2"
                            >
                                <Image
                                    src="/logo_vector.svg"
                                    alt="Zaffaron Logo"
                        ...
                        <footer className="w-full py-8 text-center text-xs text-muted-foreground border-t mt-12">
                            <div className="container mx-auto px-4 space-y-2">
                                <p className="opacity-70">
                                    Zaffaron matches Buyers with independent Chefs. Payment is
                                    off-platform. Chefs are solely responsible for food safety and
                                    local compliance. Service is a Pilot Program.
                                </p>
                                <p className="opacity-40">v2.5.4 (MVP)</p>
                            </div>
                        </footer>
                    </main>
                    <ChefAssistant />
