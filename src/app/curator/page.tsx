...
export default function CuratorPage() {
    ...
    if (loading)
        return (
            <div className="flex h-screen items-center justify-center text-saffron-600 font-bold text-xl">
                <Loader2 className="animate-spin mr-2" /> Loading Curator...
            </div>
        );
    ...
    if (!currentRecipe)
        return (
            <div className="flex h-screen items-center justify-center flex-col">
                ...
                <button
                    onClick={fetchMissingRecipes}
                    className="mt-4 px-4 py-2 bg-saffron-600 text-white rounded"
                >
                    Check Again
                </button>
            </div>
    ...
    return (
        <div className="flex h-screen bg-neutral-50 overflow-hidden">
            ...
            <div className="w-1/3 bg-white border-r border-neutral-200 p-8 flex flex-col shadow-xl z-10">
                <div className="mb-6">
                    <h2 className="text-xs font-bold text-saffron-600 uppercase tracking-widest mb-1">
                        The Curator
                    </h2>
                    ...
                    <div className="mt-2 text-sm text-neutral-500 font-medium">
                        {currentRecipe.category?.name || 'Persian Cuisine'}
                    </div>
                </div>
                ...
                <div className="bg-neutral-100 p-4 rounded-xl mb-6">
                    ...
                    <ol className="list-decimal list-inside text-sm text-neutral-600 space-y-2">
                        <li>
                            Click <b>Search Google</b> on the right.
                        </li>
                        <li>
                            Right-click a good image &rarr; <b>Copy Image Address</b>.
                        </li>
                ...
                <div className="mt-auto border-t pt-6">
                    <button
                        onClick={handleNext}
                        className="w-full flex items-center justify-center py-4 bg-neutral-200 hover:bg-neutral-300 text-neutral-700 font-bold rounded-xl transition-colors mb-2"
                    >
                        <SkipForward className="w-5 h-5 mr-2" /> Skip this Recipe
                    </button>
                    <div className="text-center text-xs text-neutral-400 mt-2">
                        {recipes.length} remaining
                    </div>
                </div>
            </div>
            ...
            <div className="w-2/3 bg-neutral-50 p-8 flex flex-col items-center justify-center">
                <div className="w-full max-w-2xl bg-white p-10 rounded-3xl shadow-lg border border-neutral-100 text-center">
                    ...
                    <p className="text-neutral-500 mb-8">
                        Search Google for "{currentRecipe.name}", copy the image link, and paste it
                        below.
                    </p>
                    ...
                    >
                        <Search className="w-6 h-6 mr-3" /> Search Google Images{' '}
                    ...
                    {manualUrl &&
                        (manualUrl.startsWith('http') || manualUrl.startsWith('data')) && (
                    ...
                    <button
                        ...
                        className={`w-full py-4 font-bold rounded-xl text-lg flex items-center justify-center transition-all ${
                            manualUrl
                                ? 'bg-saffron-600 hover:bg-saffron-700 text-white shadow-lg'
                    ...
                    >
                        {saving ? (
                            ...
                            <>
                                <Save className="w-6 h-6 mr-2" /> Save Image
                            </>
                        )}
                    </button>
                </div>
