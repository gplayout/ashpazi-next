            ...
            <div className="hidden lg:flex flex-col justify-between w-1/2 relative bg-neutral-900 border-r border-neutral-800 p-12 text-white">
                ...
                <div className="relative z-10">
                    <Link href="/" className="flex items-center gap-2">
                        <span className="font-bold text-2xl tracking-tight text-amber-500">
                            Zaffaron
                        </span>
                    </Link>
                </div>
                ...
                <div className="relative z-10 max-w-lg space-y-4">
                    <h1 className="text-4xl font-extrabold leading-tight tracking-tight">
                        ...
                        <span className="text-amber-500">Persian Cuisine</span>
                    </h1>
                    <p className="text-lg text-neutral-400">
                        Join our community of chefs and food lovers. Save your favorite recipes,
                        create shopping lists, and explore the authentic tastes of Iran.
                    </p>
                </div>
            ...
            <div className="flex-1 flex flex-col justify-center items-center p-8 lg:p-12 relative animate-in fade-in slide-in-from-right-8 duration-700">
                <div className="w-full max-w-sm space-y-8">
                    <div className="flex flex-col space-y-2 text-center items-center">
                        <Link href="/" className="lg:hidden font-bold text-2xl text-amber-600 mb-8">
                            Zaffaron
                        </Link>
                    ...
                    <div className="space-y-4">
                        ...
                        <form className="space-y-4">
                            ...
                            <div className="flex flex-col gap-3 pt-2">
                                <Button
                                    formAction={login}
                                    className="h-11 bg-amber-600 hover:bg-amber-700 text-white font-medium"
                                >
                                    Sign In
                                </Button>
                                <Button
                                    formAction={signup}
                                    variant="ghost"
                                    className="h-11 text-muted-foreground hover:text-black dark:hover:text-white"
                                >
                                    Create an account
                                </Button>
                            </div>
