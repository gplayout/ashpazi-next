...
export const metadata: Metadata = {
    title: 'Blog | Zaffaron',
    description:
        'Explore Persian cuisine through our curated articles, cooking tips, and recipe collections.',
};
        ...
        <main className="min-h-screen bg-background pb-20">
            ...
            <section className="relative w-full py-20 px-6 bg-gradient-to-b from-primary/10 to-background flex flex-col items-center text-center space-y-4">
                ...
                <p className="text-lg text-muted-foreground max-w-xl">
                    Discover the secrets of Persian cuisine, cooking tips, and curated recipe
                    collections.
                </p>
            </section>
