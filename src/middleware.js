...
export async function middleware(request) {
    ...
    if (country) {
        switch (country.toUpperCase()) {
            case 'IR': geoLang = 'fa'; break;
            case 'FR': geoLang = 'fr'; break;
            case 'DE': geoLang = 'de'; break;
            case 'CN': geoLang = 'zh'; break;
            case 'JP': geoLang = 'ja'; break;
            case 'ES':
            case 'MX':
            case 'AR': // Argentina
            case 'CO': geoLang = 'es'; break;
            case 'SA':
            case 'AE':
            case 'EG': geoLang = 'ar'; break;
            case 'US':
            case 'GB':
            case 'CA':
            case 'AU': geoLang = 'en'; break;
            default: geoLang = 'en'; // Default for rest of world? Or 'fa' as per original project root?
