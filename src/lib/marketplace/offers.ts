...
export const MVP_OFFERS: Offer[] = [
    {
        ...
        message:
            'Hi, I found your {{SKU}} on Zaffaron. Is it available for pickup? (Zaffaron Order Ref: {{DATE}})',
...
export function getOffer(slug: string): Offer | null {
    if (!slug) return null;
    return MVP_OFFERS.find(o => o.enabled && o.key.toLowerCase() === slug.toLowerCase()) || null;
}
