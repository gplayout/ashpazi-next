...
export default function RecipeDetailClient({ recipe }) {
    ...
    const displayDifficulty = language === 'fa' ? (difficultyMap[difficulty] || difficulty) : difficulty;

    const category = recipe.category || 'Persian Cuisine';
    const displayCategory = language === 'fa' ? (categoryMap[category] || category) : category;
