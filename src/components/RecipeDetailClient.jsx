...
export default function RecipeDetailClient({ recipe, initialLang }) {
    ...
    // Zero-Flash Logic
    const validLangs = ['en', 'fa', 'de', 'fr', 'es', 'ar', 'zh', 'ja', 'it', 'pt', 'tr', 'hi', 'ko'];
    ...
    const displayPrepTime = language === 'fa' ? toPersianDigits(recipe.prep_time_minutes) : recipe.prep_time_minutes;
    const displayCookTime = language === 'fa' ? toPersianDigits(recipe.cook_time_minutes) : recipe.cook_time_minutes;
