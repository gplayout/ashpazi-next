        ...
        <section className="relative w-full py-12 md:py-20 px-4 md:px-6 bg-gradient-to-b from-primary/10 to-background flex flex-col items-center text-center space-y-6">
            ...
            <div className="flex flex-wrap justify-center gap-3 md:gap-4 mt-6">
                <Link href="/judge" className="group">
                    <div className="flex items-center gap-2 md:gap-3 px-4 py-2 md:px-6 md:py-3 bg-amber-500/10 border border-amber-500/30 rounded-full hover:bg-amber-500/20 transition-all duration-300 hover:scale-105">
                        <Star size={18} className="text-amber-600 md:w-5 md:h-5" />
                        <span className="font-medium text-sm md:text-base text-amber-700 dark:text-amber-400">
                            {getUiLabel('ai_judge', language)}
                        </span>
                    </div>
                </Link>
                <Link href="/fridge" className="group">
                    <div className="flex items-center gap-2 md:gap-3 px-4 py-2 md:px-6 md:py-3 bg-cyan-500/10 border border-cyan-500/30 rounded-full hover:bg-cyan-500/20 transition-all duration-300 hover:scale-105">
                        ...
                        <span className="font-medium text-sm md:text-base text-cyan-700 dark:text-cyan-400">
                            {getUiLabel('fridge_vision', language)}
                        </span>
                    </div>
                </Link>
            </div>
